...
class BankUi:
    def __init__(self,root):
        self.root = root
        self.header = Label(self.root,text="PRAGATI BANK OF INDIA",bg="#0019fc",fg="white",font=("arial",20,"bold"))
        self.header.pack(fill=X)
        self.frame = Frame(self.root,bg="#0019fc",width=900,height=500)
        root.geometry("800x500")
        self.button1 = Button(self.frame,text="Click to begin",bg="#50A8B0",fg="white",font=ARIAL,command = self.begin_page)
...
root = Tk()
root.title("Pragati Bank of India")
root.geometry("800x500")
